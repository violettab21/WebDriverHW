...
public class GoogleCalculatorPage {
    ...
    public CalculationResultsPage addTooEstimate () throws InterruptedException {
    ...
    public GoogleCalculatorPage addInstancesFieldsValues() throws InterruptedException {
        ...
        //Number of instances
        driver.findElement(By.xpath("//label[contains(text(),'Number of instances')]/following-sibling::input")).sendKeys("4");
        ...
        WebDriverWait ulWaitSeries = new WebDriverWait(driver, 30);
        ulWaitSeries.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//label[contains(text(),'Series')]/following-sibling::md-select")));
